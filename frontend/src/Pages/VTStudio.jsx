      ...
      <header className="h-14 px-4 sm:px-6 flex items-center justify-between border-b border-gray-800 bg-[#0f0f0f] shadow-md">
        ...
        >
          ...
          <h1 className="text-lg sm:text-xl font-bold tracking-wide text-white">
            VT <span className="text-[#ffffff]">Studio</span>
          </h1>
        </div>

        <div className="flex items-center gap-3 sm:gap-4">
          <button
            className="bg-[#272727] px-3 sm:px-4 py-1 lg:rounded-lg rounded-full hover:bg-[#161414] active:scale-95 transition cursor-pointer text-sm md:flex hidden items-center justify-center gap-1"
            onClick={() => {
              navigate("/createpage");
            }}
          >
          ...
          <img
            ...
            alt=""
            className="w-8 h-8 sm:h-9 sm:w-9 rounded-full border border-gray-600 object-cover hover:scale-105 transition"
        ...
        <aside className="hidden md:flex w-56 lg:w-64 bg-[#121212] border-r border-gray-800 flex-col p-4 shadow-lg">
          ...
          <nav className="space-y-2">
            ...
            <SidebarItem
              ...
              active={active}
              setActive={setActive}
              onClick={() => navigate("/vtstudio/content")}
            />
            <SidebarItem
              icon={<FaChartBar />}
              text="Analytics"
            ...
            <SidebarItem
              ...
              active={active}
              setActive={setActive}
              onClick={() => navigate("/vtstudio/revenue")}
            />
          </nav>
        </aside>
